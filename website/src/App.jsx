          ...
          <Layout>
            ...
            <Content className={classNames({ 'auth ': _auth.isLogged() })}>
              <Switch>
                ...
                <Route path="/institutions/:slug" element={<ReservedArea />} />
                <Route path="/institutions/:slug/edit" element={<ReservedArea />} />
                ...
                <Route path="/faqs" element={<ReservedArea />} />
                <Route path="/faq" element={<ReservedArea />} />
