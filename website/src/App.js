...
import { DeploymentUnitOutlined, UserOutlined, LogoutOutlined, MenuOutlined, EditOutlined } from '@ant-design/icons';
      ...
      <Provider store={Store}>
        <Layout className={'page ' + classNames({ 'auth ': _auth.isLogged() }) + classNames({ 'collapsed ': collapsed })}>
          ...
          <Layout>
            ...
            {!_auth.isLogged() &&
             <Footer>© diversa21.org {new Date().getFullYear()}</Footer>
            }
          </Layout>
        </Layout>
      </Provider>
