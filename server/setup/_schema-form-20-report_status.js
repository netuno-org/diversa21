...
_form.sync(
	_val.map()
		...
		.set("show_id", true)
		.set("title", "Estado")
		.set("uid", "2fabf653-ea3b-4331-bb28-9d934e4d322a")
);
_form.syncField(
	"2fabf653-ea3b-4331-bb28-9d934e4d322a",
	_val.map()
		.set("colspan", 0)
		.set("description", "")
		.set("firebase", "")
		...
		.set("title", "C\u00F3digo")
		.set("type", "text")
		.set("uid", "405f92f8-8946-4074-ae45-0755b53180eb")
		.set("unique", false)
		.set("user_id", 0)
		.set("whenedit", true)
		.set("whenexport", true)
...
_form.syncField(
	...
	_val.map()
		...
		.set("title", "T\u00EDtulo")
		.set("type", "text")
		.set("uid", "6334d701-6ad9-4cc1-8a4e-1ee1844cfcde")
		.set("unique", false)
		.set("user_id", 0)
		.set("whenedit", true)
		.set("whenexport", true)
