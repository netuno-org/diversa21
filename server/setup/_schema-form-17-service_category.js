...
_form.sync(
	_val.map()
		...
		.set("show_id", true)
		.set("title", "Categoria")
		.set("uid", "b540479b-40cf-4517-b50c-ca3b66931f5b")
);
_form.syncField(
	"b540479b-40cf-4517-b50c-ca3b66931f5b",
	_val.map()
		.set("colspan", 0)
		.set("description", "")
		.set("firebase", "")
		...
		.set("title", "Descri\u00E7\u00E3o")
		.set("type", "text")
		.set("uid", "72b0607f-a106-4e87-878e-4400b3b5cf71")
		.set("unique", false)
		.set("user_id", 0)
		.set("whenedit", true)
		.set("whenexport", true)
...
_form.syncField(
	...
	_val.map()
		...
		.set("title", "Nome")
		.set("type", "text")
		.set("uid", "c19172f0-4805-441a-bc48-524ab8f36364")
		.set("unique", false)
		.set("user_id", 0)
		.set("whenedit", true)
		.set("whenexport", true)
